...
public class KeepItDownPlugin : BaseUnityPlugin {
    ...
    public bool AddConfig(string key, string section, ConfigFile cfg = null) {
        return Config.AddVolumeConfig(key, section, cfg);
    }
    
    public bool TryGetConfig(string key, out VolumeConfig config) {
    ...
    public bool Bind(string key, GameObject gameObject, float baseVolume, Action<float> volumeSetter) {
    ...
    /// <returns>Whether or not the binding was successfully created.</returns>
    public bool BindAudioSource(string key, AudioSource audioSource) {
    ...
    /// <returns>Whether or not the binding was successfully created.</returns>
    public bool BindAudioSources(string key, params AudioSource[] audioSources) {
    ...
    public bool RemoveBindings(string key, GameObject gameObject) {
        if (!TryGetConfig(key, out var volumeConfig)) {
